...
public class MyPawnHorizontal : MyPawn
{
            ...
            if (CurrentY < 7)
                ...
                else if (CurrentX < 7)
                {
                    ...
                    if (CurrentY == 1)
                    {
                        ...
                        c1 = MyBoardManager.Instance.ChessPieces[CurrentX, CurrentY + 1, CurrentZ];
                        c2 = MyBoardManager.Instance.ChessPieces[CurrentX, CurrentY + 2, CurrentZ];
                        c3 = MyBoardManager.Instance.ChessPieces[CurrentX, CurrentY + 3, CurrentZ];
                        c4 = MyBoardManager.Instance.ChessPieces[CurrentX, CurrentY + 4, CurrentZ];

                        if (c1 == null && c2 == null && c3 == null && c4 == null)
                            r[CurrentX, CurrentY + 4, CurrentZ] = true;
